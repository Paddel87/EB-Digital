...
1. **Spike M (Fahrzeugbezeichnungs-Schema)** — letzter offener Phase-5-Spike; Fragenkatalog für die DPolG liegt versandfertig vor ([`docs/spikes/spike-m-fragenkatalog.md`](docs/spikes/spike-m-fragenkatalog.md)); wartet auf Stakeholder-Antworten. _(Spike G/H/K/L erledigt: **ADR-021–024**.)_
2. **Phase 6 (UMSETZUNG)** — Geo + Disponent-/Betreuer-PWAs + Resilience + Retention + Export — beginnt nach Phase-5-Abschluss.
