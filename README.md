...
1. **Spike L (Tile-Caching-Strategie)** — Eingangsbedingung: MapTiler-Key in `.env`. _(Spike G: **ADR-021** Valhalla; Spike H: **ADR-022** Backup; Spike K: **ADR-023** Hilfe-Knopf.)_
