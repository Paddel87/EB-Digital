...
- **Projektphase:** Phase 2 (Auth + Tenants + Verbund-Tauglichkeit, UMSETZUNG) **in Arbeit**: Schritt 2.1 (Datenmodell-Skelett), Schritt 2.2 (`backend/auth` Login + Cookie-Sessions + Valkey-Rate-Limit nach ADR-013), Schritt 2.3 (`backend/auth_anonymous` URL-Token + AccessCode-Validierung + Anonymous-Session-Cookie), Schritt 2.4 (`backend/tenants` Self-Service-Antrag + Approve + CRUD + Reset-Token-Flow + S10 Participation-Lookup) und Schritt 2.5 (`frontend-disponent` Login + Dashboard-Skelett + Reset-Password-UI) alle `[ERLEDIGT]` 2026-05-10 / 2026-05-11 / 2026-05-12 / 2026-05-15. **Hot-Stabilisierung 2.5b** am 2026-05-16: `get_db_session()` Lifecycle-Bug-Fix (FastAPI-yield-Dependency mit Rollback im Exception-Pfad, ADR-015 / Regel-018) — `[ERLEDIGT]` 2026-05-16. Phase 1 (Repo-Bootstrap & Tech-Foundations) vollständig abgeschlossen — Schritte 1.1–1.8 zwischen 2026-05-08 und 2026-05-10.
- **Version:** v0.1.0
- **Status:** Konzeption
