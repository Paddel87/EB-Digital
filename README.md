...
1. **Spike-K-Konzept freigeben** ([`docs/spikes/spike-k-results.md`](docs/spikes/spike-k-results.md)) → ADR-Anlage Hilfe-Knopf-Semantik — letzte offene Phase-5-Freigabe. _(Spike G: **ADR-021** Valhalla; Spike H: **ADR-022** Backup-Strategie C.)_
2. **Spike L** (braucht MapTiler-Key) und **Spike M** (DPolG-Rückfrage) als letzte Phase-5-Spikes.
