...
1. **Spike-L-ADR-Entwurf freigeben** ([`docs/spikes/spike-l-results.md`](docs/spikes/spike-l-results.md)): Tile-Caching — `CacheFirst` + ExpirationPlugin, Operationsraum-Pre-Cache beim Schichtbeginn (4–12 MB), client-TTL ~24 h. _(Spike G: **ADR-021**; H: **ADR-022**; K: **ADR-023**.)_
2. **Spike M (Fahrzeugbezeichnungs-Schema)** — Fragenkatalog für die DPolG liegt versandfertig vor ([`docs/spikes/spike-m-fragenkatalog.md`](docs/spikes/spike-m-fragenkatalog.md)); wartet auf Stakeholder-Antworten.
