...
## 9. Reifegrad-Übersicht (Stand 2026-05-10)
...
| Schnittstelle S8a (Sub-Surface `/api/auth/login`, `/api/auth/logout`, `/api/auth/me`)               | BELASTBAR | 2026-05-10 | Schritt 2.2 produktiv: Login-Flow gegen PlatformAdmin/Dispatcher/Carer; Cookie-Round-Trip mit Starlette `SessionMiddleware`; End-to-End-Smoke grün. Tenants- und Users-CRUD-Sub-Surfaces folgen in 2.4.                                                                                                                                                                                                     |
