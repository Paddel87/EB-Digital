...
- **Reifegrad:** `[VORLÄUFIG]`, seit 2026-05-07. **Eingebettete `[OFFEN]`-Bereiche:** Bündelungs-Trigger (Spike J), Hilfe-Knopf-Semantik (Spike K). **Eingebettete `[VORLÄUFIG]`-Bereiche:** Geo-Plausibilitäts-Algorithmus (über ADR-017 spezifiziert, Implementation in Phase 4).
...
- **Offene Fragen:** Bündelungs-Trigger (Spike J), Hilfe-Knopf-Semantik (Spike K). Bis zur Klärung gilt: keine produktive UMSETZUNG der jeweiligen Bereiche. **Geklärt 2026-05-18:** Geo-Plausibilitäts-Algorithmus durch ADR-017 (Hülle-Distanz + dynamische GPS-Toleranz `2·accuracy_m`, 500-m-Moderationsfilter, Text-Standort als Moderation, dreistufige Konfigurations-Hierarchie). Implementations-Plan in Phase 4 plus additive Schema-Migration (`tenant.plausibility_default_threshold_m`, `operation.plausibility_threshold_m`).
...
| backend/operations                                                                                        | VORLÄUFIG | 2026-05-07 | UMSETZUNG-Phase, mit `[OFFEN]`-Bereichen Spike J, Spike K. Spike-I-Bereich (Plausibilitäts-Algorithmus) seit 2026-05-18 `[VORLÄUFIG]` durch ADR-017.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
