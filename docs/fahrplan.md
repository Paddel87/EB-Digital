...
- **Aktiver Schritt:** **4.3a** `backend/operations` Teil 1 (Operations + Orders + Plausibility + Audit-Log + Assignment + CancelOrder) IN ARBEIT seit 2026-05-28. Schritt 4.3 wurde am 2026-05-28 in **4.3a** + **4.3b** (Bündelung, ADR-018) aufgespalten — Detail-Plan-Frage 0C; Begründung: ADR-017 und ADR-018 als zwei unabhängige Phase-3-Spike-Outputs verdienen zwei mittelgroße statt einen riesigen PR. Detail-Plan-Freigabe 4.3a: `0C/1A/2A/3A/4A/5A/6A/7A/8A/9A/10A`.
...
- **Nächster Schritt:** **4.3a** läuft (siehe Aktiver Schritt). Nach 4.3a-Abschluss folgt **4.3b** (Bündelung, ADR-018) mit eigenem Detail-Plan-Vorlauf, danach **4.4** (`backend/realtime`).
...
| 4     | Operations Core + Realtime + Einsatzkraft-PWA                           | UMSETZUNG             | –                 | LÄUFT (4.1 + 4.2 ERLEDIGT 2026-05-28; 4.3 in 4.3a + 4.3b aufgeteilt 2026-05-28; 4.3a IN ARBEIT; ADR-019 Sonderregel)                                    |
...
- **Status:** IN ARBEIT (Detail-Plan freigegeben 2026-05-28: 0C/1A/2A/3A/4A/5A/6A/7A/8A/9A/10A)
- **Phasentyp-Kontext:** UMSETZUNG
