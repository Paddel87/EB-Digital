...
- **Stand vom:** 2026-06-11 (Session-Update 5: **5.2 / Spike H ERLEDIGT** — Patrick-Freigabe Option C, **ADR-022** Backup-Strategie + Recovery-Reihenfolge + RTO/RPO; 2/5 Phase-5-Spikes erledigt)
...
| 5     | Spikes Wave 2 – Geo, Frontends, Resilience, Roll-out                    | ERKUNDUNG             | G, H, K, L, M     | LAUFEND (begonnen 2026-06-10; **5.1/G + 5.2/H ERLEDIGT (ADR-021/ADR-022)**, 5.3/K WARTET-AUF-FREIGABE, 5.4/5.5 OFFEN)                                                     |
