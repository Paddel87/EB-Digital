...
- **Stand vom:** 2026-06-09 (Session-Update: 4.5 ERLEDIGT — `frontend-einsatzkraft` Bestell-PWA, F2-Bestellpfad funktional validiert)
...
- **Aktiver Schritt:** keiner. **4.5** (`frontend-einsatzkraft` — anonyme Bestell-PWA, F2 Hard-Path) **ERLEDIGT** 2026-06-09 — Bestellpfad produktiv: Katalog (S2b) nach Kategorie + Mengen-Stepper, Standorterfassung (Geolocation/Text), Bestellung (S2c, genau-eine-Referenz-Mapping), Live-Status der eigenen Bestellung via WS-Client (S9, erster WS-Konsument im Frontend, Pong + Auto-Reconnect); 80 Vitest-Tests grün (+33), Coverage `src/lib/` 95.21 % Lines / 82.53 % Branches, Build (adapter-static) grün. Detail-Plan-Freigabe `0A–10A`. Karten-Anzeige + 150-m-Annäherung bleiben Phase 6. `frontend-einsatzkraft` bleibt `[VORLÄUFIG]` (Pattern-Beförderung nach Phase-6-Last-Test). Branch `feat/4.5-einsatzkraft-pwa`.
- **Nächster Schritt:** **4.6** (Tests + Coverage-Anker — Coverage-Frischlauf aller in Phase 4 belastbaren Module; `backend/operations` ≥ 90 %).
...
| 4     | Operations Core + Realtime + Einsatzkraft-PWA                           | UMSETZUNG             | –                 | LÄUFT (4.1 + 4.2 ERLEDIGT 2026-05-28; 4.3a ERLEDIGT 2026-06-06; 4.3b ERLEDIGT 2026-06-07; 4.4 ERLEDIGT 2026-06-08; 4.5 ERLEDIGT 2026-06-09; 4.6 nächster; ADR-019 Sonderregel) |
