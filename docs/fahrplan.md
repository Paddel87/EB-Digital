...
- **Nächster Schritt:** **Phase 5 (Spikes Wave 2)** — ERKUNDUNG. Erste Spikes: **Spike G** (Sperrungs-Override-Technik, vor `backend/geo`-UMSETZUNG in Phase 6), **Spike H** (Resilience-Granularität RTO/RPO), **Spike K** (Hilfe-Knopf-Semantik), **Spike L** (Tile-Caching-Strategie Frontend), **Spike M** (Fahrzeugbezeichnungs-Schema, Stakeholder-Rückfrage DPolG).
...
| 5     | Spikes Wave 2 – Geo, Frontends, Resilience, Roll-out                    | ERKUNDUNG             | G, H, K, L, M     | NÄCHSTE (laufende Phase ab 2026-06-09)                                                                                                                                    |
