...
// `credentials: "include"`, weil Auth über HttpOnly-Cookies läuft. Baseurl
// ist leer (relative Pfade) — funktioniert mit Vite-Dev-Proxy und mit
// Caddy/nginx in Production gleichermaßen.

export type ApiErrorKind =
  | "auth" // 401 — nicht angemeldet
  | "forbidden" // 403 — angemeldet, aber unzureichende Rechte
  | "not-found" // 404
  | "gone" // 410 — Token verbraucht/abgelaufen
  | "conflict" // 409 — z. B. Slug-Kollision
  | "validation" // 422
  | "rate-limit" // 429
  | "server" // 5xx
